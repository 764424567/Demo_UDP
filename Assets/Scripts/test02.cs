...
public class test02 : MonoBehaviour
{
    ...
    Socket socketClient;
    IPEndPoint iep;
    private string udpClictIP;
    byte[] sendData = new byte[1024];

    // Use this for initialization
    void Start()
    {
        udpClictIP = "192.168.15.201";
        udpClictIP = udpClictIP.Trim();
    ...
    public void Bind_Event(int i)
    {
        switch (i)
        {
            case 0:
                ...
                sendData = Encoding.UTF8.GetBytes(strMsg);
                //发送
                socketClient.SendTo(sendData,sendData.Length,SocketFlags.None, iep);
                break;
            case 1:
